    ...
    >
      ...
      <header className="w-full px-6 lg:px-14 pt-6 pb-4 flex items-center justify-between z-30">
        ...
        <div className="flex items-center space-x-3 sm:space-x-4">
          <a
            className="hidden sm:flex items-center gap-2 px-4 py-2 rounded-full bg-slate-900/70 hover:bg-slate-900/90 border border-white/15 text-slate-100 text-xs font-medium backdrop-blur-sm transition-all"
            href="tel:+911800123360"
          >
            <span className="material-symbols-outlined text-[16px] text-brand-orange">call</span>
            <span className="tracking-wide">+91 1800 123 360</span>
          </a>

          <button
            onClick={() => navigate('overview')}
            className="flex items-center bg-white hover:bg-slate-100 text-slate-900 rounded-full pl-1.5 pr-5 py-1.5 shadow-md font-bold text-xs sm:text-[13px] tracking-tight transition-transform duration-200 hover:scale-105 active:scale-95"
          >
            <span className="w-7 h-7 rounded-full bg-brand-orange flex items-center justify-center text-white mr-2.5 shadow-inner">
