    ...
    <div className="flex flex-col gap-spacing-lg pb-spacing-2xl">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-spacing-md bg-surface p-spacing-lg rounded-xl shadow-sm border border-outline">
        ...
        <div className="flex flex-wrap items-center gap-spacing-sm shrink-0">
          <button
            onClick={() => addToast('Exporting Charter', 'Governance charter PDF downloaded.', 'info')}
            className="flex items-center gap-1.5 px-4 py-2.5 bg-surface-variant hover:bg-surface text-on-secondary-container rounded-lg font-label-large text-label-large transition-all shadow-sm border border-outline"
            type="button"
          >
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-2.5 bg-primary-container hover:bg-surface-container-high text-on-primary-container rounded-lg font-label-large text-label-large transition-all shadow-sm"
            type="button"
          >
            <span className={`material-symbols-outlined text-[18px] ${simulationRunning ? 'animate-spin' : ''}`}>
              {simulationRunning ? 'sync' : 'rule_settings'}
            </span>
            <span>{simulationRunning ? 'Simulating...' : 'Test Simulation'}</span>
          </button>
          <button
            onClick={() => setIsNewQuoteOpen(true)}
            className="flex items-center gap-1.5 px-4 py-2.5 bg-tertiary-container hover:bg-tertiary text-on-tertiary rounded-lg font-label-large text-label-large transition-all shadow-md"
            type="button"
          >
