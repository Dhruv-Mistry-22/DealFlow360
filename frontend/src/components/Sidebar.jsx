...
export default function Sidebar() {
  const { currentPage, navigate, mobileMenuOpen, setMobileMenuOpen } = useApp();
    ...
    <div className="flex flex-col h-full justify-between select-none">
      ...
      <div className="p-spacing-md border-t border-outline bg-surface shrink-0">
        <div
          ...
          className="flex items-center gap-spacing-sm p-spacing-xs rounded-lg hover:bg-surface-variant transition-colors cursor-pointer"
        >
